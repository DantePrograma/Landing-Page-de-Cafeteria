...
import cafeColombino from "/src/imagenes/cafedeargentina.jpeg";
...
export const products = [
  {
    ...
    description:
      "Sumérgete en la auténtica experiencia del café argentino con nuestro exquisito blend.",
    price: 9.999,
  ...
  },
  {
    ...
    description:
      "Embárcate en un viaje sensorial con nuestro café colombiano de calidad premium.",
    price: 7.999,
  ...
  },
  {
    ...
    title: "Cafe Italiano",
    description:
      "Explora la esencia del café italiano con nuestro exquisito producto.",
    price: 8.999,
    imagen: cafeItaliano,
  },
  {
    ...
    title: "Cafe Frances",
    description:
      "Embárcate en un viaje sensorial con nuestro café francés de la más alta calidad.",
    price: 9.999,
    imagen: cafeFrances,
  },
  {
    ...
    description:
      "Descubre Portugal en cada sorbo con nuestro Café Premium: auténtico y tostado a la perfección.",
    price: 8.999,
